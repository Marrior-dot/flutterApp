...
DATABASES = {
    'default': {
        ...
        'NAME': f"{BASE_DIR}/database/initial-db.sqlite"
    }
}
...
MEDIA_ROOT = BASE_DIR #os.path.join(BASE_DIR,'/images')  #'/home/mann/Desktop/projetos/appFlutter/projeto_perguntas/assets'
print(MEDIA_ROOT)
STATIC_URL = 'static/'
