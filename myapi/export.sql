INSERT INTO auth_user (password,last_login,is_superuser,username,last_name,email,is_staff,is_active,date_joined,first_name) VALUES
	 ('pbkdf2_sha256$720000$riAbfF8eCYylAxzrqB4O9z$TI2L6W39YQl55b0WGtOm5q1cqPFOLW3cL+3SYkvQKkg=','2024-11-19 16:16:52.387046',1,'admin','','',1,1,'2024-05-06 15:56:34.926003','');
...
INSERT INTO myapp_postagem (arquivo,content,likes,dislikes,escolha_unica,title) VALUES
	 ('','a primeira postagem',18,1,0,'LoremIpsum'),
	 ('','conteudo novo',11,0,0,'LoremIpsum'),
	 ('','asdasd',4,0,0,'LoremIpsum'),
	 ('','Postagem de teste 3',8,0,0,'LoremIpsum'),
	 ('images/imagemTeste1_KRwUcML.jpeg','Pergunta com respostas',24,0,1,'LoremIpsum'),
	 ('images/images.jpeg','Perguntas com Respostas 2',16,1,0,'LoremIpsum'),
	 ('','Teste para o websocket',0,0,0,'LoremIpsum'),
	 ('','agora vai',0,0,0,'LoremIpsum'),
	 ('','asdadasdasdasd',0,0,0,'LoremIpsum'),
	 ('','ereeeeeeeererererererer',0,0,0,'LoremIpsum');
INSERT INTO myapp_postagem (arquivo,content,likes,dislikes,escolha_unica,title) VALUES
	 ('','erererer',0,0,0,'LoremIpsum'),
	 ('','rrrrrrrrrrrrrrrrrrrrrr',0,0,0,'LoremIpsum'),
	 ('','ffffffffffffffffffffffffffffffffffffffffffffffffffffffffff',0,0,0,'LoremIpsum'),
	 ('','erttterere',2,0,0,'LoremIpsum');
